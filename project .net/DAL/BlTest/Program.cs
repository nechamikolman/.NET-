...
namespace BlTest
{
    internal static class Program
    {
        ...
        static void CheckCustomerExists()
        {
            ...
            {
                var c = ReadCustomerInput();
                bool exists = s_bl.customer.IfCastomerExsist(c);
